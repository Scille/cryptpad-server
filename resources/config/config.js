...
const CUSTOM_PROTOCOL = process.env.CRYPTPAD_CUSTOM_PROTOCOL || 'vector:';

// Limit workers to avoid resource exhaustion on cloud platforms
// Set CRYPTPAD_MAX_WORKERS explicitly, or leave undefined to use all cores
const MAX_WORKERS = process.env.CRYPTPAD_MAX_WORKERS ? Number(process.env.CRYPTPAD_MAX_WORKERS) : undefined;
// </Parsec customization>
 ...
 */
    ...
    */
    ...
    // <Parsec customization>
    // add custom url scheme for CSP needs
