...
echo "🐧 Building CryptPad for Unix/Linux..."
...
Build script for cryptpad-server (Unix/Linux).
...
if [ "$COMPRESS" = true ]; then
    ...
    find ./www -type f -print0 | grep -E $TO_COMPRESS_FORMATS | xargs -0 -P 0 -I % gzip --no-name %
